...
export default function ProductDetails() {
    ...
    useEffect(() => {
        ...
        fetch("http://localhost:8000/api/products")
            ...
            .then(data => {
                // Transform data into the format expected by the table
        ...
        <div className="Container">
            ...
            <div className="flex w-full cursor-pointer">
                <div className="sidebar bg-[#FFA800] text-white p-5 w-[20%] font-bold text-[20px] flex flex-col items-center h-screen">
                    <Link to="/admin-dashboard">                    <div className="menu-item mt-10 mb-4 w-full flex items-center justify-start pl-5">
                        <MdDashboard className="mr-[22px]" />
                        <span>Dashboard</span>
                    </div></Link>
                    <Link to="/product-details">                    <div className="menu-item mt-10 mb-4 w-full flex items-center justify-start pl-5">
                        <FaUser className="mr-[22px]" />
                        <span>Product Details</span>
                    </div></Link>
                    <Link to="/user-details">                    <div class="menu-item mt-10 mb-4 w-full flex items-center justify-start pl-5">
                        <FaBitbucket className="mr-[22px]" />
                        <span>User Details</span>
                    </div></Link>
                    <Link to="/login">                    <div className="menu-item mt-10 w-full flex items-center justify-start pl-5">
                ...
                <div className="main-dashboard p-5 w-full">
                    <div className="info-cards flex justify-between mb-5 space-x-4">
                        <div className="card bg-red-500 text-white p-3 w-1/4 h-[170px] flex flex-col justify-between rounded-lg shadow-md">
                            ...
                            <Link to="/admin-dashboard">                            <button className="mt-auto py-2 bg-red-700 rounded-b-lg w-full">
                                Show order
                            </button></Link>
                        </div>
                        <div class="card bg-green-500 text-white p-3 w-1/4 flex flex-col justify-between rounded-lg shadow-md h-[170px]">
                            ...
                            <Link to="/product-details">                            <button className="mt-auto py-2 bg-green-700 rounded-b-lg w-full">
                                Show Products
                            </button></Link>
                        </div>
                        <div className="card bg-blue-500 text-white p-3 w-1/4 flex flex-col justify-between rounded-lg shadow-md h-[170px]">
                            ...
                            <Link to="/user-details">                            <button className="mt-auto py-2 bg-blue-700 rounded-b-lg w-full">
                                Show Users
                            </button></Link>
                        </div>
                    </div>
